...
import type { SemanticSpacesV2 } from "../spaces/semantic-model.js";
...
export interface LegacyEditorStateV1 {
  site: { width: number; depth: number; coverageLimit: number };
  commonAreaMm2: number;
  rooms: LegacyRoomV1[];
  walls: LegacyWallV1[];
  reference: { show: boolean; opacity: number };
  snap: boolean;
  showLabels: boolean;
}
...
export interface ProjectV2 {
  ...
  readonly spaces: DeferredModelSlotV2 | SemanticSpacesV2;
