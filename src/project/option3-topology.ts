import { coordinateUm, type LengthUm } from "../core/units.js";
import {
...
import { insertWall, type WallProposal } from "../topology/operations.js";
 ...
 */
export const OPTION_3_CURATED_WALL_RUNS: readonly CuratedWallRun[] = [
...
export function createOption3TopologyV2(): TopologyV2 {
...
function proposal(wallRun: CuratedWallRun): WallProposal {
  return {
